...
class PollsControllerTest < ActionController::TestCase
  ...
  test "should create poll" do
    assert_difference('Poll.count') do
      post :create, poll: { acumulated_score: @poll.acumulated_score, final_result: @poll.final_result }
    end
  ...
  test "should update poll" do
    patch :update, id: @poll, poll: { acumulated_score: @poll.acumulated_score, final_result: @poll.final_result }
    assert_redirected_to poll_path(assigns(:poll))
  end
